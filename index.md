...
🎉 **Recent Publications:**: 
  - My new work (with my former student) is now accepted for publication in in <a href="https://www.sciencedirect.com/journal/discrete-applied-mathematics" style="text-decoration: none;">Discrete Applied Mathematics</a>. We provide a rare closed-form lower bound for a class of minimizing quadratic functions over a discrete polyhedral set. 
  - My new work (with Francesca Maggioni jointly supervising Gabriele Marchesi) is now accepted in the upcoming NeurIPS MLxOR Workshop. This marks my first time in a NeurIPS venue!
  - My new work (with Dmitry Gromov) is now published in <a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0319550" style="text-decoration: none;">PLOS ONE</a>. We study a unique interdisciplinary problem: how do we model the spread of fear/worry during pandemics? Thanks to the German DFG for supporting me.
  - My new work (with Steffen Rebennack) is now published in <a href="https://www.tandfonline.com/doi/full/10.1080/24725854.2025.2525918" style="text-decoration: none;">IISE Transactions</a>. We study optimal strategies for allocating scarce medical resources under uncertainty. Thanks to the German DFG for supporting me.
